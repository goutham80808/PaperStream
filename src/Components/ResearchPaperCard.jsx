...
export default function ResearchPaperCard({ paper, isActive, onLike }) {
  ...
  return (
    ...
    >
      {/* Title */}
      <h2 className="text-3xl font-bold mb-3 text-gray-800 dark:text-white">{paper.title}</h2>
      ...
      {/* Summary */}
      <p className="text-base text-gray-700 dark:text-gray-300 mb-4 px-4">{paper.summary}</p>
